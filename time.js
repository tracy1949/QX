...
[Script]
cron "0 0/30 7-23 * * *" script-path=https://github.com/congcong0806/surge-list/raw/master/Script/time.js
...
async function time() {
	var now = new Date(); 
	var content = "";
	var week = "            "+calcTime(+8)+" 星期" + "一二三四五六日".charAt(now.getDay());
	content += week;
	for (var i in areas) {
...
function calcTime(offset) { 
    ...
    return nd.format("yyyy年MM月dd日 hh:mm:ss"); 
}
